  ...
  render() {
    return (
      <main className="finish">
          ...
          <p>Oavsett hur du önskar gå vidare finns vi här för att hjälpa dig, så <a href="mailto:kontakt@fodelsebyran.se">hör gärna av dig till oss</a> så slussar vi dig vidare till rätt instans eller person.</p>
      </main>
    )
  }
}
